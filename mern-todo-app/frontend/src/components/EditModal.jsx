    ...
    <div className={editModal? "modal active" : "modal"}>
      <div className="wrapper">
        <div className="topbar">
          ...
          <button className="closeButton" onClick={() => { dispatch(closeEditModal()) }}>X</button>
        </div>
        <form onSubmit={async(e)=>{
          ...
          <div className="content">
            <div className="area">
              ...
              <span>Update List İtem </span>
            </div>
          </div>
          <div className="buttons">
            <button type="button" onClick={() => { dispatch(closeEditModal()) }}>Cancel</button>
