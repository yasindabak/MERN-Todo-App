...
const AddModal = () => {
  ...
  const { addModal } = useSelector(state => state.modal); // 'AddModal' küçük harfle 'addModal' olarak düzeltildi
    ...
    <div className={addModal ? "modal active" : "modal"}>
      <div className="wrapper">
        <div className="topbar">
          ...
          <button className="closeButton" onClick={() => { dispatch(closeAddModal()) }}>X</button>
        </div>
        <form onSubmit={async(e)=>{
          ...
          <div className="content">
            <div className="area">
              <textarea type="text" required="required" value={textareaValue} onChange={(e)=>{
